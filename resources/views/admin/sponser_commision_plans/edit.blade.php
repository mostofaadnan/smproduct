            ...
            <div class="card">
                <div class="card-body">
                    <form role="form" method="POST"
                        action="{{ route('admin.sponsor_generetion_plans.update', $item->id) }}">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="plan_title" class="form-control"
                                        value="{{ $item->plan_title }}" placeholder="@lang('Title')" required>
                                </div>

                                <div class="form-group col-md-12 mx-auto">
                                    <label>@lang('Sponsore Commission') <span class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <input type="text" name="sponsore_commission" class="form-control"
                                            value="{{ $item->sponsore_commission }}" placeholder="@lang('Sponsore Commission')"
                                            required>
                                ...
                                <div class="form-group col-md-12 mx-auto">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="total_generation" id="total_generation"
                                            class="form-control" value="{{ $item->total_generation }}"
                                ...
                                <div id="plan_details">
                                    @foreach ($item->details as $detail)
                                        <div class="form-group col-md-12 mx-auto">
                                            <div class="input-group">
                                                <div class="input-group-append">
                                                    <div class="input-group-text">{{ $detail->generation }} @lang('Generation')
                                                    </div>
                                                </div>
                                                <input type="hidden" name="generation[]" value="{{ $detail->generation }}">
                                                <input type="number" name="commission[]" class="form-control"
                                                    placeholder="@lang('Commission')" step="any" value={{ $detail->commission }} required>
                                                <div class="input-group-append">
                                                    <div class="input-group-text">@lang('%')</div>
                                                </div>
                                            </div>
