                                ...
                                @forelse($items as $key => $item)
                                    <tr>
                                        ...
                                        <td data-label="@lang('Action')">
                                            <a href="{{ route('admin.attribute_types.edit', $item->id) }}" type="button"
...
@push('breadcrumb-plugins')
    <a href="{{ route('admin.attribute_types.create') }}" class="btn btn-sm btn--success btn_modal" type="modal"><i
