        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{ menuActive('admin.items*', 3) }}">
                        <i class="menu-icon la la-list"></i>
                        <span class="menu-title">@lang('Item') </span>
                    </a>
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.sponsor_generetion_plans.index') }}">
                    <a href="{{ route('admin.sponsor_generetion_plans.index') }}" class="nav-link">
                        <i class="menu-icon las la-life-ring"></i>
                        <span class="menu-title">@lang('Generation Plan')</span>
                    </a>
                </li>
