...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
       ...
       $depositsMonth = Deposit::whereYear('created_at', '>=', Carbon::now()->subYear())
        ...
        return view('admin.dashboard', compact('general','page_title', 'widget', 'report', 'withdrawals', 'chart','payment','paymentWithdraw','latestUser', 'bv', 'depositsMonth', 'withdrawalMonth'));
    }
