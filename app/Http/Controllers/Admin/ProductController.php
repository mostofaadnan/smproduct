...
class ProductController extends Controller
{
    ...
    {
        $items = product::latest()->paginate(getPaginate());
        $page_title = 'Products';
        $empty_message = 'No Product Created Yet.';
        return view('admin.items.products.index', compact('items', 'page_title', 'empty_message'));
    }
    public function create()
    {
        ...
        return view('admin.items.products.create', compact('categories', 'units', 'page_title'));
    }
